  ...
  return (
    <section className="home-view">
      ...
      <section className="buttons">
        <Link to="/mani-maker"> <button id="maniMaker" className="nav-home">Mani-Maker</button> </Link>
        <Link to="/collection"> <button id="myColl" className="nav-home">My Collection</button> </Link>
      </section>
